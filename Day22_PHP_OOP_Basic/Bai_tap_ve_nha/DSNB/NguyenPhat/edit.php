...
class Books
{
    ...
    public function editBook()
    {
        ...
        $query_insert = "UPDATE Books SET `name` = '$this->name',`type` = '$this->type',`author` = '$this->author',`amount` = '$this->amount' WHERE id = $id";
        $is_update = mysqli_query($connection, $query_insert);
